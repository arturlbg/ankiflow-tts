...
def test_build_audio_filename_is_deterministic_and_uses_slug() -> None:
    first = build_audio_filename("Please review this card.", "model-a", "voice-a")
    second = build_audio_filename("Please review this card.", "model-a", "voice-a")
...
def test_build_audio_filename_changes_with_model_or_voice() -> None:
    base = build_audio_filename("Hello there", "model-a", "voice-a")
    changed_model = build_audio_filename("Hello there", "model-b", "voice-a")
    changed_voice = build_audio_filename("Hello there", "model-a", "voice-b")
